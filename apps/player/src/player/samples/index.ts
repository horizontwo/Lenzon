...
export const quickScript: PresentationScript = {
  meta: {
    title: 'Lenzon — quick tour',
    repoUrl: 'local://lenzon',
  ...
  scenes: [
    {
      ...
      narration:
        'Lenzon turns an analysis of a codebase into a short animated presentation. An agent writes the script, and the client plays it back.',
      holdSeconds: 5,
