/**
 * Shared types for the Lenzon core renderer and service layer.
 *
...
export interface TextBoxOptions {
  ...
  y?: number;
  /**
   * Wrap budget in CSS pixels. When set, the text is greedily word-wrapped so
   * no line exceeds this width. Omit for the original single-line behavior.
   */
  maxWidth?: number;
  fx?: EffectSpec[];
}
