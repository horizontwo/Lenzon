...
structured script; a browser-based player renders that script into animated
scenes with synchronized narration.

This repository is the **open surface** of Lenzon: the player and template
